    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepairCertId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    EngineerId = table.Column<int>(type: "int", nullable: false),
                    MachineId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairCerts", x => x.RepairCertId);
                    table.ForeignKey(
                        name: "FK_RepairCerts_Engineers_EngineerId",
                        column: x => x.EngineerId,
                        principalTable: "Engineers",
                        principalColumn: "EngineerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairCerts_Machines_MachineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairCerts_EngineerId",
                table: "RepairCerts",
                column: "EngineerId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairCerts_MachineId",
                table: "RepairCerts",
                column: "MachineId");
        }
